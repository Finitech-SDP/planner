...
function getType(tile) {
    if (tile.classList.contains("road")) return "roadTile";
    if (tile.classList.contains("parking")) return "parkingTile";
    if (tile.classList.contains("blocked")) return "blockedTile";
    if (tile.classList.contains("hub")) return "hubTile";
}
